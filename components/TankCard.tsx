...
import { Tank, Task, CheckEntry, UserId } from "@/lib/types";
import { isTaskDoneToday } from "@/lib/store";
import TaskRow from "./TaskRow";
import FeedingSuggestion from "./FeedingSuggestion";
...
export default function TankCard({ tank, tasks, entries, activeUserId, onCheck, onUpdateTank }: Props) {
