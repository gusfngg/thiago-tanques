...
- In production, set `DATABASE_URL` to use Postgres (durable and shared between instances).
- If `DATABASE_URL` is not set, it falls back to SQLite local file (good for local dev only).
